...
import { causaRaizDe, desenlaceDe, ORDEN_ESTADOS, type EstadoPedido, type Desenlace } from '@/lib/core/casos'
import { esGrupoProducto, MOTIVO_GRAVEDAD } from '@/lib/core/motivos'

// ============================================================================
// FASE 2 del plan multi-empresa: el DOMINIO PURO vive ahora en lib/core/
// (motivos, casos, envío). Este módulo re-exporta esos nombres para que ningún
// import existente se rompa (refactor estrangulador). Acá queda solo el ACCESO
// A DATOS, que en la fase 3 pasa detrás de puertos con TenantContext.
// ============================================================================
export * from '@/lib/core/motivos'
export * from '@/lib/core/casos'
export * from '@/lib/core/envio'
