// ============================================================================
// CORE · Cierre del día — los indicadores del día y el texto EXACTO que ve el
// panel y reenvía n8n a Telegram. Dominio puro, movido tal cual desde
// lib/supabase/cierre.ts (fase 2).
// ============================================================================

import { MOTIVO_LABEL } from '@/lib/core/motivos'
